...
import { properties } from './ApifyNaverAIOverview.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'fKI5Ckh8aKOioEU1U' as string;

export const PACKAGE_NAME = 'n8n-nodes-naver-ai-overview-api' as string;
export const CLASS_NAME = 'ApifyNaverAIOverview' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'naver-ai-overview-app' as string;

export const DISPLAY_NAME = 'Naver AI Overview' as string;
export const DESCRIPTION =
	'Get the Naver AI Overview for a query, including the summary and source references' as string;

export class ApifyNaverAIOverview implements INodeType {
